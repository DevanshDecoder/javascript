...
const tinderuser = {};// singleton constructor can be written either this type or above mentioned method
// console.log(tinderuser);
...
//haaOWnProperty is used to check that the property is existing in the code or not
console.log(webuser.hasOwnProperty("isLoggedIn"));
>>>>>>> c4e5954 (Initial commit)
